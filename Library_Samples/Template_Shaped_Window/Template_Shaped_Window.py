...
if __name__ == "__main__":
    ...
    #                           |
    #                          \|/
    root.wm_title("Your Minimised Window Title...")
    start_pos = [0, 0]
    ...
    #                           |
    #                          \|/
    controls_file_loc = 'Path to control/widget positions file...'
    ...
    #                           |
    #                          \|/
    passive_ui = Image.open("Path to the UI passive image here...").convert("RGBA")
    ...
    # Change here
    # Enable the following initialization if you choose to add Minimize and/or Close buttons
    #
